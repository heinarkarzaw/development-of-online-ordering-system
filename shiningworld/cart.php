...
<head>
    ...
    <title>Lighting and Electronics | Shining World - Cart</title>
                                    ...
                                    <a class="btn-hover" href="cart.php"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22"
                                            ...
                                            <g id="Icon" transform="translate(-1524 -89)">
                                                <ellipse id="Ellipse_2" data-name="Ellipse 2" cx="0.909" cy="0.952"
                                                    ...
                                                    fill="#343a40" stroke="#1a2224" stroke-linecap="round"
                                                    stroke-linejoin="round" stroke-width="2" />
                                                ...
                                                <path id="Path_3" data-name="Path 3"
                                                    ...
                                                    transform="translate(1524 89)" fill="#343a40" stroke="#1a2224"
                                                    stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                                            </g>
                                        </svg>
                                        <?php 
                                    ...
                                    <a class="btn-hover" href="cart.php">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22"
                                            ...
                                            <g id="Icon" transform="translate(-1524 -89)">
                                                <ellipse id="Ellipse_2" data-name="Ellipse 2" cx="0.909" cy="0.952"
                                                    rx="0.909" ry="0.952" transform="translate(1531.364 108.095)"
                                                    fill="#000" stroke="#1a2224" stroke-linecap="round"
                                                    stroke-linejoin="round" stroke-width="2" />
                                                <ellipse id="Ellipse_3" data-name="Ellipse 3" cx="0.909" cy="0.952"
                                                    rx="0.909" ry="0.952" transform="translate(1541.364 108.095)"
                                                    fill="#000" stroke="#1a2224" stroke-linecap="round"
                                                ...
                                                <path id="Path_3" data-name="Path 3"
                                                    d="M1,1H4.636L7.073,13.752a1.84,1.84,0,0,0,1.818,1.533h8.836a1.84,1.84,0,0,0,1.818-1.533L21,5.762H5.545"
                                                    transform="translate(1524 89)" fill="#000" stroke="#1a2224"
                                                    stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                                            </g>
                                        </svg>
                                        <?php 
...
<section class="cart-area">
        <div class="container">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="dashboard-nav">
                        <ul class="list-inline">
                            <li class="list-inline-item"><a href="user-dashboard.php">Account settings</a></li>
            ...
            <?php 
                ...
                {
                    echo '<a href="cart.php?productID=$productID&Action=Clear">>> Clear cart << <small>Remove all items in cart</small></a>';
                    $size=count($_SESSION['ShoppingCartFunctions']);
                    if ($size==0) 
                    {
                        echo "<p>Your cart is empty.</p>";
                    ...
                    {   
                        ...
                        $stock=$_SESSION['ShoppingCartFunctions'][$i]['stock'];
            ...
            ?>
                        ...
                        <div class="body">
                            <div class="item">
                                <div class="image">
                                    <img src="adminpanel/<?php echo $productImage1 ?>">
                                </div>
                                <div class="name">
                                    <div class="name-text">
                                ...
                                <div class="price">
                                <?php 
                                    echo "<a class='del' href='cart.php?productID=$productID&Action=Remove'>Remove</a>";
                                ?>
                                </div>
                                <div class="price">
                                <span><?php echo $price * $buyQty?> Kyat</span>
                                </div>
                                <div class="info">
                                    <div class="product-pricelist-selector-quantity">
                                        <span><?php echo $buyQty?> item</span>                    
                                    </div>
                                </div>  
                            </div>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="apply-coupon">
                        <h6>Payment</h6>
                            ...
                            <table id="PaymentTable" name="PaymentTable" border="0" width="100%">
                                <tr>
                                    <td>
                                        Name <small>(as it appears on your card)</small><br/>
                                        <input type="text" class="form-control" name="txtNameOnCard" placeholder="Name"  /><br/>
                                        Card Number <small>(no dashes or spaces)</small><br/>
                                        <input type="text" class="form-control" name="txtNameOnCard" placeholder="Card Number"  /><br/>
                                        Expriration Date <small>(no dashes or spaces)</small><br/>
                                        <table width="100%">
                                            <tr>
                                                <td>
                                                    <select class="form-control" name="cboMonth" >
                                        ...
                                        <br/>
                                        Security Code <small>(3 on Back, Amex: 4 on front)</small>
                                        <input type="number" class="form-control" name="txtSecurityCode" placeholder="e.g. 123" ><br/>                                
                                    </td>
                                </tr>
                            </table>       
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="card-price">
                        ...
                        <div class="card-price-list d-flex justify-content-between align-items-center">
                            ...
                            <div class="price">
                                <p><?php echo CalculateTotalAmount() ?> Kyat</p>
                            </div>
                        </div>
                        <div class="card-price-list d-flex justify-content-between align-items-center">
                            <div class="item">
                                <p>Delivery Date (Y-m-d)</p>
                            </div>
                            <div class="price">
                                <p><?php echo date("Y-m-d", strtotime(' + 3 days')) ?></p>
                            </div>
                        </div>
                        <div class="card-price-list d-flex justify-content-between align-items-center">
                            <div class="item">
                            ...
                            <div class="price">
                                <p><?php echo CalculateVAT() ?> Kyat</p>
                            </div>
                        </div>
                        <div class="card-price-subtotal d-flex justify-content-between align-items-center">
                            ...
                            <div class="total-price">
                                <p style="color: #335AFF;"><?php echo CalculateTotalAmount()+CalculateVAT() ?> Kyat</p>
                            </div>
                        </div>  
                        <br/> 
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form__div mb-0">
                                    ...
                                    <input type="text" class="form__input" name="txtAddress" placeholder="" value="<?php echo $address ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-12 mt-30">
                                <div class="form__div">
                                    <input type="text" class="form__input" name="txtCity" placeholder="" value="<?php echo $city ?>" required>
                                 </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-12 mt-30">
                                <div class="form__div">
                                    <input type="text" class="form__input" name="txtTownship" placeholder="" value="<?php echo $township ?>" required>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-12 mt-30">
                                <div class="form__div">
                                    <input type="text" class="form__input" name="txtPhone" placeholder="" value="<?php echo $phone ?>" required>
                                </div>
                            </div>
                        </div>
                        <input type="hidden" name="txtOrderDate" value="<?php echo date("Y-m-d") ?>">
                        <input type="hidden" name="txtDeliveryDate" value="<?php echo date("Y-m-d", strtotime(' + 3 days')) ?>">
                        <input type="hidden" name="txtOrderNo" value="<?php echo AutoID('orders','orderNo','ORD-',6) ?>">
                        <button type="submit" name="btnBuy" class="bg-opacity"><a class="btn bg-primary" >Checkout Now</a></button>
                    </div>
                </div>
            </div>
            <?php 
                ...
                {   
                    ...
                    { 
                        ...
                        $txtProductID = $_SESSION['ShoppingCartFunctions'][$i]['productID'];                         
                        $txtBuyQty = $_SESSION['ShoppingCartFunctions'][$i]['buyQty'];
                        $grandTotal = CalculateTotalAmount()+CalculateVAT();
                        $Orderquery= "INSERT INTO orders(orderNo, orderDate, customerID, address, township, city, phone, productID, buyQty, grandTotal, paymentType, deliveryDate )
                                    Values('$txtOrderID', '$orderDate', '$customerID', '$txtAddress', '$txtTownship', '$txtCity', '$txtPhone', '$txtProductID', '$txtBuyQty', '$grandTotal', '$rdoPaymentType', '$deliveryDate')";
                    ...
                    if ($result) 
                    {
                        echo"<script>window.alert('Thank you for your shopping')</script>";
                        echo"<script>window.location='shop.php'</script>";
                        ClearShoppingCart();
                        $update = "UPDATE product
                                    SET stock=stock-'$txtBuyQty'
