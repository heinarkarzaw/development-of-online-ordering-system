...
<head>
    ...
    <title>Lighting and Electronics | Shining World - Home</title>
                ...
                <div class="d-none d-lg-block">
                    <nav class="menu-area d-flex align-items-center">
                        ...
                        <ul class="main-menu d-flex align-items-center">
                            <li><a id ="line-hover" class="active" href="index.php">Home</a></li>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 order-2 order-lg-1">
                        <div class="banner-area__content">
                            <h2>Lighting and Electronics shop for everyone.</h2>
                            <p>Lighting, electronics, home appliances, fans and more.</p>
                            <a class="btn bg-primary" href="shop.php">Shop Now</a>
                        </div>
                    </div>
                    <div class="col-lg-6 order-1 order-lg-2">
                        <div class="banner-area__img">
                            <img src="dist/images/home.jpg" alt="home-img" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    ?>
                            ...
                            <div class="product-item">
                                <div class="product-item-image">
                                    <a href="product-details.php?productID=<?php echo $productID ?>"><img src="adminPanel/<?php echo $productImage1 ?>" alt="<?php echo $productImage1 ?>" class="img-fluid"></a>
                                    <div class="cart-icon">
                                        <a href="add_to_wishlist.php?productID=<?php echo $productID ?>"><i class="far fa-heart"></i></a>
                                        <input type="hidden" name="txtBuyQty" value="1" min="1" max="<?php echo $stock ?>">
                                        <button type="submit" name="buy" class="bg-opacity" min="1">
                                            <a>
                                ...
                                <div class="product-item-info">
                                    <a href="product-details.php?productID=<?php echo $productID ?>"><?php echo $productName ?></a>
                                    <span><?php echo $price ?> Kyat</span>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 ">
                            <div class="about-area-content-img">
                                <img src="dist/images/shop.jpg" alt="img" class="img-fluid">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="about-area-content-text">
                                <h3>Why Shop with Shining World</h3>
                                <p>Shining World is the best shop in Myanmar.</p>
                                <div class="icon-area-content">
                                    ...
                                    <div class="icon-area">
                                        <i class="far fa-check-circle"></i>
                                        <span>Have fast delivery.</span>
                                    </div>
                                    <div class="icon-area">
                                        <i class="far fa-check-circle"></i>
                                        <span>Warrenty all products.</span>
                                    </div>
                                </div>

                                <a class="btn bg-primary" href="shop.php">Get Started</a>
                            </div>
                        </div>
                    </div>
                </div>
