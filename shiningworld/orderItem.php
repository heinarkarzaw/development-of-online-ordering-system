<?php 
    ...
    $select=   "SELECT p.*, o.* 
                ...
                where p.productID = o.productID AND customerID = '$customerID' AND o.orderNo = '$orderNo'";
...
<head>
    ...
    <title>Lighting and Electronics | Shining World - Order History</title>
            ...
            <div class="row">
                ...
                <div class="rows">
                    <div class="cart-items">
                        ...
                        <h3 style="color: #335AFF;">Grand Total: <?php echo $grandTotal?> Kyat</h3> 
                        <?php 
                            for ($i=0; $i < $count; $i++) 
                            { 
