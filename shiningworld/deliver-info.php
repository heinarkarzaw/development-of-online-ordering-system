<?php 
    ...
    if (isset($_POST['btnSaveAddress'])) 
    {
        ...
        $uCity = $_POST['txtCity'];
        $uTownship = $_POST['txtTownship'];
        $uPhone = $_POST['txtPhone'];

        $update = "UPDATE customer SET  address = '$uAddress',
                   city = '$uCity', township ='$uTownship', phone = '$uPhone' WHERE customerID='$uCustomerID'";
        $query=mysqli_query($connect,$update);
        if ($query) 
        {
            echo "<script> alert('Update success!')</script>";
            echo "<script>window.location = 'deliver-info.php'</script>";
        }
    }
 ?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Lighting and Electronics | Shining World - deliver-Info</title>
                    ...
                    <nav class="menu-area d-flex align-items-center">
                        ...
                        <div class="menu-icon ml-auto">
                            <ul>
                                ...
                                <li>
                                    <a href="user-dashboard.php"><svg xmlns="http://www.w3.org/2000/svg" width="18"
                                            ...
                                            <g id="Account" transform="translate(1 1)">
                                                ...
                                                <circle id="Ellipse_9" data-name="Ellipse 9" cx="4" cy="4" r="4"
                                                    transform="translate(4)" fill="#EBCE3C" stroke="#EBCE3C"
                                                    stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                                            </g>
                                        </svg></a>
                                </li>
                ...
                <div class="col-lg-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Default address</li>
                        </ol>
                    </nav>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="dashboard-nav">
                        <ul class="list-inline">
                            ...
                            <li class="list-inline-item"><a href="deliver-info.html" class="active">Default address</a></li>
                    ...
                    <p>You can change your default address here at anytime.</p>
                    <!-- Dashboard-Nav  End-->
                </div>
                ...
                <div class="col-lg-9">
                    <div class="deliver-info-form">
                        ...
                        <form action="deliver-info.php" method="POST">
                            <div class="row">
                                <div class="col-12">
                                    <div class="form__div mb-0">
                                        <input type="hidden" name="txtCustomerID" value="<?php echo $customerID; ?>" />
                                        <input type="text" class="form__input" name="txtAddress" placeholder=" " required>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-12 mt-30">
                                    <div class="form__div">
                                        <input type="text" class="form__input" name="txtCity" placeholder=" " required>
                                        <label for="" class="form__label">City</label>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-12 mt-30">
                                    <div class="form__div">
                                        <input type="text" class="form__input" name="txtTownship" placeholder=" " required>
                                        <label for="" class="form__label">Township</label>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-12 mt-30">
                                    <div class="form__div">
                                        <input type="text" class="form__input" name="txtPhone" placeholder=" " required>
                                        <label for="" class="form__label">Phone</label>
                                    </div>
                                </div>
                            </div>
                            <button class="btn bg-primary" name="btnSaveAddress" type="submit">Save Changes</button>
                        </form>
                    </div>
                </div>
            </div>
