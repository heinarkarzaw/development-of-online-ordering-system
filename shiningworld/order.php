<?php 
    ...
    $select="SELECT Distinct orderNo, orderDate, deliveryDate FROM orders where customerID = '$customerID'";
            ...
            <div class="row">
                ...
                <div class="rows">
                    <div class="cart-items">
                        <div class="header">
                            <div class="image">Order Date</div>
                            <div class="name">Order No</div>
                            <div class="image">Delivery Date</div>
                        </div>
                    <?php 
                        for ($i=0; $i < $count; $i++) 
                        { 
                    ...
                    ?>
                        <div class="body">
                            <div class="item">
                                ...
                                <div class="name">
                                    <div class="name-text">
                                        <p> <?php echo $orderNo ?><a href="orderItem.php?orderNo=<?php echo $orderNo ?>"><br/>
                                        View Items</a></p>
                                    </div>
                                </div> 
                                <div class="image">
