<?php   
 ...
 {  
      $output = '';  
      $sql = "SELECT * FROM category where categoryName != 'Lighting' AND parentID=0";  
      $result = mysqli_query($connect, $sql);  
      while($row = mysqli_fetch_array($result))  
      {  
           $output .= '<option value="'.$row["categoryID"].'">'.$row["categoryName"].'</option>';  
 ...
 {  
      ...
      {  
            ...
            $output .=  '<form action="electronics.php" method="GET" enctype="multipart/form-data">';
...
<head>
    ...
    <title>Lighting and Electronics | Shining World - Electronics</title>
                ...
                <div class="d-none d-lg-block">
                    <nav class="menu-area d-flex align-items-center">
                        ...
                        <ul class="main-menu d-flex align-items-center">
                            ...
                            <li><a id ="line-hover" class="active" href="electronics.php">Electronics</a></li>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="search-wrapper">
                        <form action="electronics.php" class="search-wrapper-box" method="POST">
