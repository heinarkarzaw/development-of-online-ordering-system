...
<head>
    ...
    <title>Lighting and Electronics | Shining World - Produt Details</title>
...
<body>
                ...
                <div class="d-none d-lg-block">
                    <nav class="menu-area d-flex align-items-center">
                        ...
                        <ul class="main-menu d-flex align-items-center">
                            ...
                            <li><a id ="line-hover" class="active" href="shop.php">Shop</a></li>
    ...
    <main>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h5><?php echo $productName ?> Details</h5>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="product">
            <div class="container">
                <form action="product-details.php" method="GET" enctype="multipart/form-data">
                            ...
                            <div class="exzoom" id="exzoom">
                                <div class="exzoom_img_box">
                                    <ul class='exzoom_img_ul'>
                                        <li><img src="adminPanel/<?php echo $productImage1 ?>" class="img-fluid"/></li>
                                        <li><img src="adminPanel/<?php echo $productImage2 ?>" class="img-fluid"/></li>
                                        <li><img src="adminPanel/<?php echo $productImage3 ?>" class="img-fluid"/></li>
                                        <li><img src="adminPanel/<?php echo $productImage1 ?>" class="img-fluid"/></li>
                                    </ul>
                                </div>
                            ...
                            <div class="product-pricelist-selector">
                               <div class="product-pricelist-selector-quantity">
                                    ...
                                    <div class="wan-spinner wan-spinner-4"> 
                                        <input type="number" name="txtBuyQty" value="1" min="1" max="<?php echo $stock ?>"> 
                                    </div>
                                </div>
                            </div>
                            <div class="product-pricelist-selector-button">
                                <button type="submit" name="buy" class="bg-opacity" min="1"><a class="btn cart-bg ">Add to cart
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-shopping-cart"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path></svg>
                                </a></button>
                                <a class="btn bg-primary cart-hart" href="add_to_wishlist.php?productID=<?php echo $productID ?>" onclick="return false:">
