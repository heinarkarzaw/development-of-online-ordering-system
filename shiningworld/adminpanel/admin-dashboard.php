<?php 
  ...
  $sql = "SELECT count(customerID) AS totalCustomer FROM customer";
  $result = mysqli_query($connect,$sql);
  $rows = mysqli_fetch_assoc($result);
  $num_customer_rows = $rows['totalCustomer'];

  $sql2 = "SELECT count(productID) AS totalProduct FROM product";
  $result2 = mysqli_query($connect,$sql2);
  $rows2 = mysqli_fetch_assoc($result2);
  $num_product_rows = $rows2['totalProduct'];

  $sql3 = "SELECT count(DISTINCT orderNo) AS totalOrder FROM orders";
  $result3 = mysqli_query($connect,$sql3);
  $rows3 = mysqli_fetch_assoc($result3);
  $num_order_rows = $rows3['totalOrder'];
 ?>
<!DOCTYPE html> 
<html>
<head>
  ...
  <title>Lighting and Electronics | Shining World - Dashboard</title>
      ...
      <div class="row"> 
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><?php echo $num_customer_rows ?><small> Customers</small></h3>
            ...
            <a href="userDataTable.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3><?php echo $num_product_rows ?><small> Products</small></h3>
            ...
            <a href="productDataTable.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3><?php echo $num_order_rows ?><small>orders</small></h3>
              <p>View Orders</p>
            </div>
            <div class="icon">
              <i class="ion ion-bag"></i>
            </div>
            <a href="orderDataTable.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
      </div>
      <!-- /.row -->
