      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="orderDataTable.php"><i class="fa fa-circle-o"></i> Order tables</a></li>
          </ul>
        </li>
      </ul>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <div class="box-tools">
                <form action="orderDataTable.php" method="POST"> 
                  <div class="input-group input-group-sm" style="width: 150px;">
                    <input type="text" name="txtOrderSearch" class="form-control pull-right" placeholder="Search Order No.">
                    <div class="input-group-btn">
                      <button type="submit" class="btn btn-default" name="btnSearchOrder"><i class="fa fa-search"></i></button>
                    </div>
                  </div>
                </form>
              </div>
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <?php 
                ...
                {
                  $orderSearch = $_POST['txtOrderSearch'];
                  $select4 = "SELECT * FROM orders WHERE orderNo LIKE '%$orderSearch%'";
