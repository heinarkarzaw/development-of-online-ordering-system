...
<head>
    ...
    <title>Lighting and Electronics | Shining World - Wishlist</title>
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="20"
                                                ...
                                                <g id="Heart" transform="translate(1 1)">
                                                    <path id="Heart-2" data-name="Heart"
                                                        ...
                                                        transform="translate(-1.549 -2.998)" fill="#343a40" stroke="#343a40"
                                                        stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                                                </g>
                                            </svg>
                                        <?php 
                ...
                <div class="cart-items">
                    ...
                    <?php
                        if (isset($_SESSION['customerID'])) 
                        {
                            if ($num_wishlist_rows==0) 
                            {
                                echo "<p>No item in your wishlist.</p>";
                            }
                            else
                            {
                        
                                $select="SELECT p.productName, p.productImage1, p.price, p.stock, w.* 
                                        FROM product p, wishlist w
                                        WHERE w.productID=p.productID AND w.customerID='$customerID'";
                    ...
                    ?>
                                    <form action="wishlist.php" method="GET" enctype="multipart/form-data">
                                        ...
                                        <div class="item">
                                            ...
                                            <div class="button">
                                                ...
                                                <a class="del" href="wishlistRemove.php?wishlistID=<?php echo $wishlistID ?>">Remove</a>
                                            </div>
                                        </div>
                                        <div class="price">
                    ...
                    <?php 
                        ...
                        {
                            echo "<p>You need to login to add items into your wishlist page.</p>";
                        }
                    ?>
                    </div>
                </div>
